...
review = read.csv("~/Documents/Spring2017/CUSP_5006_ML4C/Test/Japanese/all_jpn_rw.csv",stringsAsFactors = FALSE, encoding = 'utf-8')
rw = review
...
rw_topic = LDA(review_dfm, k=5, method = "Gibbs", control = list(iter = 500))
